...
<div role="main" class="main">
    ...
    <section class="page-header page-header-modern page-header-background bg-color-dark p-relative z-index-1 lazyload" data-bg-src="img/demos/digital-agency-2/bg/page-header-bg-dark.jpg">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 our-services">
                    <h4 class="text-color--dark custom-text-8 font-weight-bold custom-title-with-icon custom-title-with-icon-primary mb-4 pb-3">We Can Help You With:</h4>
...
<div class="service-card ps-5 py-4 mb-4 bg-color-dark bg-color-hover-primary w-100 font-weight-semibold custom-text-4 line-height-6 text-color-light p-relative">
                ...
                <div class="col-xl-8 mt-lg-5 mt-xl-0">
                    ...
                    <div class="pb-5 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="800">
                        <img src="img/demos/digital-agency-2/our-services/our-services-detail-1.jpg" class="img-fluid">
                    </div>
                    ...
                    <div class="testimonial testimonial-style-2">
                        <blockquote>
                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec hendrerit vehicula est, in consequat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec hendrerit vehicula est.</p>
                        </blockquote>
