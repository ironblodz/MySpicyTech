...
if (isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
    ...
    if (ini_get('allow_url_fopen')) {
        ...
        $arrResult = ['response' => 'error', 'errorMessage' => 'You need CURL or file_get_contents() activated in your server. Please contact your host to activate.'];
    ...
    if ($responseData->success) {
        ...
        $arrResult = ['response' => 'error', 'errorMessage' => 'reCaptcha Error: Verifcation failed (no success). Please contact the website administrator.'];
        echo json_encode($arrResult);
    }
} else {
    $arrResult = ['response' => 'error', 'errorMessage' => 'reCaptcha Error: Invalid token. Please contact the website administrator.'];
    echo json_encode($arrResult);
}
